import { BOARD_2P, BOARD_3P, BOARD_4P } from "~/games/tigers-path/boards"
  ...
  return (
    <div className={page}>
      ...
      <span className={meta}>
        ...
        {three.clearings} clearings, {three.paths} paths + {three.slots} slots = {three.total} actions. 4P:{" "}
        {four.clearings} clearings, {four.paths} paths + {four.slots} slots = {four.total} actions.
      </span>
      ...
      <a className={link} href="/tigers-path/print/board/4p-north">4P — North, 24×18 full sheet (landscape) →</a>
      <a className={link} href="/tigers-path/print/board/2p-solo">2P — solo, letter portrait (Grassland off-board) →</a>
      <a className={link} href="/tigers-path/print/board/4p-template">
        4P — blank template, letter landscape (hand-draw grid) →
      </a>
